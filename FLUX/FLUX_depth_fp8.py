...
transformer = FluxTransformer2DModel.from_single_file("/root/autodl-tmp/.cache/huggingface/hub/models--boricuapab--flux1-depth-dev-fp8/snapshots/e88c032dcb759924635956bdbfee5362e1f5c0fe/flux1-depth-dev-fp8.safetensors", torch_dtype=dtype, cache_dir=cache_path, local_files_only = True).to(device)

quantize(transformer, weights=qfloat8)
freeze(transformer)

print("loading text_encoder")
text_encoder_2 = T5EncoderModel.from_pretrained(bfl_repo, subfolder="text_encoder_2", torch_dtype=dtype, cache_dir=cache_path, local_files_only = True).to(device)
